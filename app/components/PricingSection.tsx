    ...
    <section id="pricing" className="bg-white py-20">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-8">
          {/* Plan 1 */}
          <div className="p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition bg-gray-50">
            ...
            <Button size="lg" className="mt-8 w-full bg-blue-500 hover:bg-blue-600">
              このプランで相談する
            </Button>
          </div>

          {/* Plan 2 */}
          <div className="p-8 rounded-2xl border-2 border-blue-500 shadow-md bg-white relative">
